...
<html lang="en">
    ...
    <body style="background-image:url(css/bgkain.jpg);background-size:cover">
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        <div class="panel-heading">
                            <h1 class="panel-title text-center">SPK PEMILIHAN KAIN TERBAIK</h1>
                            <center><img class="img-fluid" src="css/III.jpg" width="50%"><br></center>
                        </div>
                        <div class="panel-body">
                            ...
                            <form role="form" action="" method="POST">
                                <fieldset>
                                    ...
                                    <input type="submit" name="submit" class="btn btn-lg btn-success btn-block" value="Masuk" >
